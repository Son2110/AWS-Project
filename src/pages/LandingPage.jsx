...
const LandingPage = () => {
  ...
  return (
    <div
      className={`min-h-screen font-sans overflow-x-hidden selection:bg-indigo-500 selection:text-white transition-colors duration-300 ${
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              to="/login"
              className={`px-6 py-2.5 rounded-full font-medium transition-all hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 ${
                isDark
        ...
        {isMobileMenuOpen && (
          <div
            className={`md:hidden absolute top-full left-0 w-full border-t shadow-xl animate-slide-down ${
              isDark
          ...
          >
            <div className="container mx-auto px-6 py-6 flex flex-col gap-4">
              ...
              <Link
                to="/signup"
                onClick={() => setIsMobileMenuOpen(false)}
                className="text-center py-3 rounded-xl font-bold text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 shadow-lg shadow-indigo-500/30"
              >
                Sign Up
              </Link>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="lg:w-1/2 text-center lg:text-left animate-slide-up">
              <div
                className={`inline-block px-4 py-1.5 mb-6 rounded-full border text-sm font-semibold tracking-wide uppercase ${
                  isDark
              ...
              >
                Seamlessly monitor and adjust temperature, humidity, and
                lighting across your entire workspace. Enhance comfort,
                efficiency, and sustainability with SmartOffice.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                ...
                <a
                  href="#features"
                  className={`w-full sm:w-auto px-8 py-4 rounded-full font-bold text-lg border transition-all ${
                    isDark
            ...
            <div className="lg:w-1/2 relative">
              <div
                className={`relative z-10 backdrop-blur-xl rounded-3xl p-6 border shadow-2xl ${
                  isDark
              ...
              >
                ...
                {/* View Details Button */}
                <button className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-semibold cursor-default shadow-lg shadow-indigo-500/30">
                  View Details
                </button>
              </div>
              {/* Decorative elements */}
      ...
      >
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            >
              Manage every aspect of your office environment with our intuitive
              IoT dashboard.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div
              className={`group p-8 rounded-3xl border transition-all duration-300 ${
                isDark
                  ? "bg-slate-800 border-slate-700 hover:border-indigo-500/50 hover:shadow-indigo-500/20"
                  : "bg-slate-50 border-slate-100 hover:border-indigo-100 hover:shadow-indigo-100/50"
              } hover:shadow-xl`}
            >
              <div
              ...
              >
                Maintain the perfect climate for productivity. Monitor real-time
                temperature and adjust HVAC systems remotely.
              </p>
            </div>
            ...
            <div
              className={`group p-8 rounded-3xl border transition-all duration-300 ${
                isDark
                  ? "bg-slate-800 border-slate-700 hover:border-blue-500/50 hover:shadow-blue-500/20"
                  : "bg-slate-50 border-slate-100 hover:border-blue-100 hover:shadow-blue-100/50"
              } hover:shadow-xl`}
            >
              <div
                className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform ${
              ...
              >
                Ensure healthy air quality by tracking humidity levels. Prevent
                mold and ensure comfort for all employees.
              </p>
            </div>
            ...
            <div
              className={`group p-8 rounded-3xl border transition-all duration-300 ${
                isDark
                  ? "bg-slate-800 border-slate-700 hover:border-yellow-500/50 hover:shadow-yellow-500/20"
                  : "bg-slate-50 border-slate-100 hover:border-yellow-100 hover:shadow-yellow-100/50"
              } hover:shadow-xl`}
            >
              <div
                className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform ${
              ...
              >
                Automate lighting based on occupancy or schedule. Save energy
                and create the right ambiance for any task.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-16">
                ...
                >
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      >
                        Reduce energy consumption by up to 30% with smart
                        automation.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      >
                        Control multiple rooms and floors from a single
                        dashboard.
                      </p>
                    </div>
                  </div>
            ...
            <div className="md:w-1/2">
              ...
              >
                Modern workplaces require modern solutions. SmartOffice isn't
                just a remote control; it's an intelligent platform that adapts
              ...
              >
                From reducing operational costs to improving employee well-being
                through better environmental control, we provide the tools you
                need to build the office of the future.
              </p>
              <Link
                to="/login"
      ...
      <section className="py-20 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto">
            Join thousands of forward-thinking companies using SmartOffice to
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-slate-500 text-sm">
              &copy; {new Date().getFullYear()} SmartOffice IoT Solutions. All
              rights reserved.
            </div>
          </div>
        </div>
